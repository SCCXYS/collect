package com.zs.myapplication.broken;
...
public class BrokanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brokan);
    ...
    private void initView(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(BrokanActivity.this,"Button onClick",Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void refreshDate(){
        ...
        listView.setAdapter(new SampleAdapter(BrokanActivity.this, android.R.layout.simple_list_item_1, items));
