package com.zs.myapplication.xRecyclerView.xrev;
...
public class XRecyclerView extends RecyclerView {
    ...
    private NoLoadingListener mNoLoadingListener;
    ...
    public void setLoadingListenerNoLoading(NoLoadingListener listener) {
        mNoLoadingListener = listener;
    }

    public interface NoLoadingListener {
