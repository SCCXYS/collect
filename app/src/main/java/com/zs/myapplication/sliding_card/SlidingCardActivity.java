...
public class SlidingCardActivity extends AppCompatActivity implements ContainerView.ContainerInterface {
    ...
    private void initData() throws Exception {
        ...
        contentView.initCardView(SlidingCardActivity.this,R.layout.sliding_card_item,R.id
        ...
        if (dataList.get(index) != null) {
            ...
            mImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(SlidingCardActivity.this,dataList.get(0).getTitle(),Toast
                            .LENGTH_SHORT).show();
                }
            });
        }
